angular.module("MetronicApp").controller('TravelExpenseController',
    ['$rootScope', '$scope', '$location', '$timeout', 'EnumService', 'TravelExpenseService', '$window', 'DictService', 'toastr',
        function ($rootScope, $scope, $location, $timeout, EnumService,  TravelExpenseService, $window, DictService, toastr) {
            ...
            $scope.search = function () {
                // TravelExpenseService.setAndClearFunction();
        ...
        ['$rootScope', '$scope', '$location', 'toastr', 'TravelExpenseService', 'DictService', 'EnumService',
            function ($rootScope, $scope, $location, toastr, TravelExpenseService, DictService, EnumService) {
                ...
                $scope.trafficeFeeChange = function () {
                    $scope.hallTrafficeFee = TravelExpenseService.getTrafficeFeeSum($scope.model.details);
                ...
                if(id){
                    TravelExpenseService.getForm(id).$promise.then(function (res) {
                        ...
                        angular.forEach(res.data.details, function (every) {
                            $scope.hallTrafficeFee += every.remiburseMoney;
                        });
                    });
                }
    ...
    .controller('CinemaSignUpAuditEditController',
        ['$rootScope', '$scope', '$location', 'toastr', 'TravelExpenseService', 'DictService', 'EnumService',
            function ($rootScope, $scope, $location, toastr, TravelExpenseService, DictService, EnumService) {
                ...
                TravelExpenseService.getAllRegions().$promise.then(function (result) {
                    if ('success' == result.status) {
                        $scope.allRegions = result.data;
                    }
                });

                TravelExpenseService.getAllProvince().$promise.then(function (result) {
                    if ('success' == result.status) {
                ...
                $scope.getProvince = function () {
                    ...
                    $scope.allCitys = "";
                    $scope.allCountys = "";
                    TravelExpenseService.getAllProvinces($scope.model.regionCode).$promise.then(function (result) {
                        if ('success' == result.status) {
                            $scope.allProvinces = result.data;
                ...
                $scope.getCity = function () {
                    ...
                    if ($scope.model.provinceCode) {
                        TravelExpenseService.getAllCitys($scope.model.provinceCode).$promise.then(function (result) {
                            if ('success' == result.status) {
                                $scope.allCitys = result.data;
                            }
                        });
                        TravelExpenseService.getRegionByProvinceCode($scope.model.provinceCode).$promise.then(function (result){
                            if("success" == result.status){
                ...
                $scope.getCounty = function () {
                    ...
                    if ($scope.model.cityCode) {
                        TravelExpenseService.getAllCountys($scope.model.cityCode).$promise.then(function (result) {
                            if ('success' == result.status) {
                ...
                TravelExpenseService.softwareUrl().$promise.then(function (result) {
                    if ('success' == result.status) {
                        $scope.softwares = result.data;
                        TravelExpenseService.getForm(cinemaApplicationId).$promise.then(function (result) {
                            if ('success' == result.status) {
                                ...
                                if ($scope.model.softwareName) {
                                    TravelExpenseService.softwareVersionUrl($scope.model.softwareName).$promise.then(function (result) {
                                        if ('success' == result.status) {
                ...
                //$scope.model = {};
                TravelExpenseService.getCreateCinemaChain().$promise.then(function (result) {
                    if ('success' == result.status) {
                ...
                $scope.seatCountsChange = function () {
                    $scope.seatSum = TravelExpenseService.getSeatSum($scope.model.screens);
                    if (!$scope.seatSum) {
                        $scope.seatSum = 0;
                    }
                };
                ...
                $scope.submit = function (cinemaForm, hallForm, investmentForm, applyForm) {
                    ...
                    if (cinemaForm.$valid && hallForm.$valid && investmentForm.$valid && applyForm.$valid) {
                        ...
                        TravelExpenseService.updateCinema($scope.model, $scope.model.id).$promise.then(function (result) {
                            if ('success' == result.status) {
    ...
    .controller('CinemaSignUpAuditEditOtherController',
        ['$rootScope', '$scope', '$location', 'toastr', 'TravelExpenseService', 'DictService', 'EnumService',
            function ($rootScope, $scope, $location, toastr, TravelExpenseService, DictService, EnumService) {
                ...
                TravelExpenseService.getForm(cinemaApplicationId).$promise.then(function (res) {
                    if ('success' == res.status) {
                        $scope.model = res.data;
                        ...
                        if ($scope.model.provinceApproval.reportFileId) {
                            TravelExpenseService.download($scope.model.provinceApproval.reportFileId).$promise.then(function (result) {
                        ...
                        if ($scope.model.provinceApproval.licenseFileId) {
                            TravelExpenseService.download($scope.model.provinceApproval.licenseFileId).$promise.then(function (result) {
                        ...
                        if ($scope.model.provinceApproval.permitFileId) {
                            TravelExpenseService.download($scope.model.provinceApproval.permitFileId).$promise.then(function (result) {
                ...
                $scope.submit = function (cinemaForm, hallForm, investmentForm) {
                    ...
                    if (cinemaForm.$valid && hallForm.$valid && investmentForm.$valid) {
                        ...
                        //如果主表成功，子表失败，修改后提交主表为修改
                        TravelExpenseService.updateCinemaInfo($scope.model, $scope.model.id).$promise.then(function (result) {
                            if ('success' == result.status) {
                                //for (var i = 0; i < $scope.model.screens.length; i++) {
                                //    $scope.model.screens[i].cinemaCode = code;
                                //}
                                TravelExpenseService.updateFirstPass($scope.model.provinceApproval).$promise.then(function (result) {
                                    if ('success' == result.status) {
    ...
    .controller('CinemaSignUpAuditCheckController',
        ['$rootScope', '$scope', '$location', 'TravelExpenseService', 'DictService', '$timeout', 'EnumService', 'toastr',
            function ($rootScope, $scope, $location, TravelExpenseService, DictService, $timeout, EnumService, toastr) {
                $scope.$on('$viewContentLoaded', function () {
                    $rootScope.settings.layout.pageBodySolid = true;
                    $rootScope.settings.layout.pageSidebarClosed = false;
                });
    ...
    .controller('CinemaSignUpAuditShowSeatController',
        ['$rootScope', '$scope', '$location', 'TravelExpenseService',
            function ($rootScope, $scope, $location, TravelExpenseService) {
                $scope.$on('$viewContentLoaded', function () {
                    Metronic.initAjax();
                    $rootScope.settings.layout.pageBodySolid = true;
                    $rootScope.settings.layout.pageSidebarClosed = false;
                ...
                TravelExpenseService.getCinemaScreenSeat($scope.cinemaCode, $scope.screenCode).$promise.then(function (res) {
    ...
    .controller('CinemaSignUpAuditFirstController',
        ['$rootScope', '$scope', '$location', '$resource', 'toastr', 'DictService', 'TravelExpenseService', 'EnumService', 'TravelExpenseService',
            function ($rootScope, $scope, $location, $resource, toastr, DictService, TravelExpenseService, EnumService, TravelExpenseService) {
                $scope.$on('$viewContentLoaded', function () {
                    // initialize core components
                    Metronic.initAjax();
                    $rootScope.settings.layout.pageBodySolid = true;
                ...
                TravelExpenseService.getForm(cinemaApplicationId).$promise.then(function (res) {
                    ...
                    if ($scope.model.code) {
                        ...
                        TravelExpenseService.getSeq($scope.model.cityCode, $scope.model.playUnitType).$promise.then(function (result) {
                            if ('success' == result.status) {
                ...
                $scope.isPass = function (firstResult, cinemaForm) {
                    ...
                    if (firstResult && cinemaForm.$valid) {
                        TravelExpenseService.updateFirstPass($scope.model.provinceApprovalModel).$promise.then(function (result) {
                            if ('success' == result.status) {
                                ...
                                $resource("bits/w/cinemas/s?page=0&size=10&s_cinemaCode=" + result.data.code + "&s_showHistory=false&sort=id,desc").save().$promise.then(function (codeResult) {
                                    if ('success' == codeResult.status) {
                                        ...
                                        TravelExpenseService.saveDocument(reportFile).$promise.then(function (res) {
                                            if ('success' == res.status) {
                                                toastr.success("", "【影院基本信息注册表】文档保存成功！");
                                            }
                                        });
                                        TravelExpenseService.saveDocument(licenseFile).$promise.then(function (res) {
                                            if ('success' == res.status) {
                                                toastr.success("", "【企业法人营业执照】文档保存成功！");
                                            }
                                        });
                                        TravelExpenseService.saveDocument(permitFile).$promise.then(function (res) {
                                            if ('success' == res.status) {
    ...
    .controller('CinemaSignUpAuditLastController',
        ['$rootScope', '$scope', '$location', 'toastr', 'DictService', 'TravelExpenseService', 'EnumService', 'TravelExpenseService',
            function ($rootScope, $scope, $location, toastr, DictService, TravelExpenseService, EnumService, TravelExpenseService) {
                $scope.$on('$viewContentLoaded', function () {
                    // initialize core components
                    Metronic.initAjax();
                    $rootScope.settings.layout.pageBodySolid = true;
                ...
                $scope.downloadreportFile = function () {
                    TravelExpenseService.downloadfile($scope.model.provinceApproval.reportFileId, $scope.reportFileId);
                };
                $scope.downloadlicenseFile = function () {
                    TravelExpenseService.downloadfile($scope.model.provinceApproval.licenseFileId, $scope.licenseFileId);
                };
                $scope.downloadpermitFile = function () {
                    TravelExpenseService.downloadfile($scope.model.provinceApproval.permitFileId, $scope.permitFileId);
                };
                ...
                $scope.isPass = function (finalResult) {
                    ...
                    if (finalResult) {
                        TravelExpenseService.updateFinallyPass($scope.model.nationApproval).$promise.then(function (result) {
                            if ('success' == result.status) {
    ...
    .filter("provinceFilter", ["TravelExpenseService", function (TravelExpenseService) {
        return function (value) {
            var provinces = TravelExpenseService.getAllProvinces();
